...
const Page = ({
  ...
  const handleCalculateSubtotal = async () => {
          ...
          <div className="w-full flex flex-row">
            <div className="w-[60%]">
              <div className="w-full py-4 font-Philosopher">
                ...
                <p className="pl-4">
                  Proceed to{" "}
                  <span className="font-bold underline">Checkout</span> to
              ...
              <div className="pt-2 px-2">
                {cart.map((product, index) => (
                  <>
                    <div
                      key={index}
                      className="text-black w-[100%] flex flex-row h-[10rem] pt-2 pb-2 px-2"
                    >
                      <div className="w-[30%]">
                        <Image
                      ...
                      <div className="w-[70%] flex flex-col">
                        ...
                        <div className="w-full">
                          <p className="pl-4 pr-2 flex flex-row items-center font-Philosopher">
                            Quantity:
                            <button
                              type="button"
            ...
            <div className="w-[40%] pt-4 pr-4">
              <div className="w-full border-2 border-black rounded-md">
                ...
                <div className="w-full flex justify-center">
                  <div className="w-[90%]">
                    {cart.map((product, index) => (
                      <div className="w-full flex flex-row font-Philosopher" key={index}>
                    ...
                    <div className="w-full flex flex-col font-Philosopher">
                      <div className="w-full flex flex-row">
                        <div className="w-[70%] flex justify-start text-xl font-bold">Subtotal:</div>
                        <div className="w-[30%] flex justify-end text-xl font-bold">₹ 20000.00</div>
                      </div>
                      <div className="w-full flex flex-row">
                        <div className="w-[70%] flex justify-start text-lg">Extra taxes/Delivery charge:</div>
                        <div className="w-[30%] flex justify-end text-lg">₹ 1000.00</div>
                      </div>
                    </div>
                    ...
                    <div className="w-full flex flex-col font-Philosopher">
                      <div className="w-full flex justify-center pb-4">
                        <button type="button" className="w-full py-2 bg-slate-500 border-2 text-white font-bold text-xl border-black rounded-md hover:bg-white hover:text-slate-700 transition-all ease-in-out duration-200">
                          Member Checkout
                        </button>
                      </div>
                      <div className="w-full flex justify-center pb-4">
